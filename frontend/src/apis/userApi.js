...
export const loginUser = (formData)=>{
  return axiosInstance.post('/user/loginValidate',formData,{withCredentials:true})
}

export const googleLogin = async()=>{
  return await axiosInstance.get('/user/auth/google',{withCredentials:true});
}
...
return axiosInstanceMultipart.post(`/user/upload-profileImg?type=${type}`,formData)
}
