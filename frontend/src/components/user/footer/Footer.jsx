      ...
      <div className="flex flex-col md:flex-row justify-between space-y-8 md:space-y-0">
        ...
        <span className="text-gray-400 text-2xl font-bold">Connect</span>
          ...
          <p className="text-gray-700">
            ...
            System with ability to change the
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            <li>
              <a href="#" className="text-gray-700 hover:text-blue-500">Find Freelancers</a>
            </li>
            <li>
              <a href="#" className="text-gray-700 hover:text-blue-500">Post Project</a>
            </li>
            <li>
              <a href="#" className="text-gray-700 hover:text-blue-500">Refund Policy</a>
            </li>
            <li>
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-gray-800">For Freelancers</h3>
          <ul className="space-y-2">
            <li>
              <a href="#" className="text-gray-700 hover:text-blue-500">Find Work</a>
            </li>
            <li>
              <a href="#" className="text-gray-700 hover:text-blue-500">Create Account</a>
            </li>
          </ul>
        </div>
        <div className="space-y-4">
