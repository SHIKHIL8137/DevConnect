...
export default function ResumeUploadComponent() {
  ...
  return (
    <div className="mb-8 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
      ...
      <p className="text-gray-500 mb-4 text-sm">Upload your resume to help employers learn about your experience</p>
      
      <div 
        className={`relative w-full p-6 border-2 border-dashed rounded-lg transition-all duration-300 ${dragActive ? "border-blue-400 bg-blue-50" : resumeFileName ? "border-green-200 bg-green-50" : "border-gray-200 bg-gray-50"} flex flex-col items-center justify-center min-h-40`}
      ...
      >
        {loading ? (
          ...
          <div className="w-full">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-medium text-gray-800 truncate max-w-xs">{resumeFileName}</p>
          ...
          <>
            ...
            <label htmlFor="resume-file" className="px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 cursor-pointer font-medium transition-colors flex items-center">
              Browse Files
            </label>
            <input
              type="file"
            ...
            />
            <p className="mt-4 text-xs text-gray-500">Accepted formats: PDF, DOC, DOCX (Max 5MB)</p>
          </>
        )}
