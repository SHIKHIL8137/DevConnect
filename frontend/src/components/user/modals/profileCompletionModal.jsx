...
const ProfileCompletionModal =()=> {
  ...
  const validate = () => {
    ...
    if (!formData.about.trim()) newErrors.about = 'Please provide a brief description about yourself';
      ...
      <div className="relative w-full max-w-md p-6 mx-4 bg-white rounded-lg shadow-xl">       
        ...
        {isCompleted ? (
          <div className="py-8 text-center">
            ...
            <h3 className="text-xl font-medium text-gray-800">Profile Completed!</h3>
            <p className="mt-2 text-gray-600">Your profile has been successfully updated.</p>
          </div>
        ) : (
          <div>
            <div className="mb-4">
            ...
            <div className="mb-4">
              <label className="block mb-2 text-sm font-medium text-gray-700" htmlFor="about">
                About
              </label>
              <textarea
                id="about"
            ...
            <div className="mb-6">
              <label className="block mb-2 text-sm font-medium text-gray-700" htmlFor="pricePerHour">
                Hourly Rate ($)
              </label>
