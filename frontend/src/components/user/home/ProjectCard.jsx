    ...
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex flex-col sm:flex-row justify-between">
        <div>
          ...
          <p className="text-gray-600 text-sm">{project.category || "Uncategorized"}</p>
        ...
        <div className="mt-4 sm:mt-0 text-right">
          ...
          <p className="text-sm text-gray-500">
            {project.timeline ? `${project.timeline} days` : "No timeline specified"}
          </p>
        </div>
      </div>
      ...
      <div className="border-t mt-6 pt-4 flex justify-end">
        <button 
          ...
          onClick={() => navigate(`/freelancer/projectDetails?id=${project._id}`)}
        >
          View Details
        </button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <p className="mb-6">
              ...
              Once submitted, the client will be able to review your profile.
            </p>
