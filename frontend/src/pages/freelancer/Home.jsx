...
const FreelancerListing = () => {
  ...
  const freelancers = [
    {
      ...
      description: "Complete redesign of an e-commerce platform using React and Tailwind CSS",
      price: "100000",
  ...
  const categories = ["All", "Frontend", "Backend", "Full Stack", "DevOps", "Mobile", "UI/UX"];
    ...
    <div className="relative min-h-screen bg-gradient-to-b from-blue-400 to-blue-600 px-4 py-8">
          ...
          <div className="text-center max-w-3xl mx-auto mt-30">
            ...
            <p className="text-white text-lg md:text-xl mb-8 opacity-90">
              Connect with skilled professionals specializing in development, design, and IT solutions
            </p>
    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50">
      ...
      <div className="md:hidden bg-white p-4 sticky top-0 z-10 shadow-sm">
        ...
        >
          ...
          <ChevronDown size={18} className={`transform transition-transform ${isMobileFilterOpen ? 'rotate-180' : ''}`} />
        </button>
      </div>
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            {categories.map((category, index) => (
              <div key={index} className={`p-2 rounded-md cursor-pointer ${category === 'All' ? 'bg-blue-100 text-blue-700' : 'hover:bg-gray-100'}`}>
                {category}
              </div>
            ))}
          </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            {budgetRanges.map((range, index) => (
              <div key={index} className="p-2 rounded-md cursor-pointer hover:bg-gray-100">
                {range}
              </div>
            ))}
          </div>
      ...
      <div className="flex-1 p-4 md:p-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
          <h1 className="text-xl md:text-2xl font-bold mb-4 md:mb-0">Available Freelancers</h1>
        ...
        <div className="space-y-4">
          {freelancers.map((freelancer) => (
            <div key={freelancer.id} className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              <div className="flex flex-col md:flex-row md:items-center justify-between">
                <div className="flex items-start">
                  ...
                  <div>
                    <h2 className="text-lg font-semibold">{freelancer.title}</h2>
                    <p className="text-gray-600 mt-1">{freelancer.description}</p>
                ...
                <div className="mt-4 md:mt-0 md:text-right">
                  ...
                  <div className="flex gap-2 mt-4 justify-start md:justify-end">
                    <button className="px-4 py-2 border border-blue-500 text-blue-500 rounded-md">Details</button>
                    <button className="px-4 py-2 bg-blue-500 text-white rounded-md">Apply</button>
                  </div>
                </div>
              </div>
            </div>
