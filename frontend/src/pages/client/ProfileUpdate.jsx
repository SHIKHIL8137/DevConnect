...
import { validateProfileForm ,formatProfileData} from '../../util/fromValidationClient';
...
useEffect(() => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-8 bg-white rounded-xl border border-gray-200 shadow-sm py-10">
      ...
      {showCropper && (
        <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex items-center justify-center p-4">
          ...
          <div>
            <label htmlFor="name" className="block font-medium text-gray-800 mb-2">Name:</label>
            <input
              type="text"
              id="userName"
              name="userName"
          ...
          <div>
            <label htmlFor="companyName" className="block font-medium text-gray-800 mb-2">Company Name:</label>
            <input
              type="text"
              id="companyName"
              name="companyName"
              ...
              onChange={handleChange}
              className={`w-full p-3 bg-gray-100 rounded-lg ${errors.companyName ? 'border-red-500' : 'border-gray-200'}`}
            />
            {errors.companyName && (
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`${errors.email ? 'border-red-500' : 'border-gray-200'} w-full p-3 bg-gray-100 rounded-lg`}
            disabled/>
          </div>
          
          <div>
            <label htmlFor="phone" className="block font-medium text-gray-800 mb-2">Phone:</label>
            <input
              type="tel"
              id="phoneNumber"
              name="phoneNumber"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="twitter" className="block font-medium text-gray-800 mb-2">Twitter:</label>
              <input
                type="text"
                id="twitter"
                name="twitter"
                ...
                onChange={handleChange}
                className={`${errors.twitter ? 'border-red-500' : 'border-gray-200'} w-full p-3 bg-gray-100 rounded-lg`}
              />
              {errors.twitter && (
            ...
            <div>
              <label htmlFor="linkedin" className="block font-medium text-gray-800 mb-2">LinkedIn:</label>
              <input
                type="text"
                id="linkedIn"
                name="linkedIn"
                ...
                onChange={handleChange}
                className={`w-full p-3 bg-gray-100 rounded-lg ${errors.linkedIn ? 'border-red-500' : 'border-gray-200'}`}
              />
              {errors.linkedIn && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="address" className="block font-medium text-gray-800 mb-2">Address:</label>
              <input
                type="text"
                id="address"
                name="address"
                ...
                onChange={handleChange}
                className={`w-full p-3 bg-gray-100 rounded-lg ${errors.address ? 'border-red-500' : 'border-gray-200'}`}
              />
              {errors.address && (
            ...
            <div>
              <label htmlFor="web" className="block font-medium text-gray-800 mb-2">Web:</label>
              <input
                type="text"
                id="web"
                name="web"
                value={formData.web}
                onChange={handleChange}
                className={`w-full p-3 bg-gray-100 rounded-lg ${errors.web ? 'border-red-500' : 'border-gray-200'}`}
              />
              {errors.web && (
