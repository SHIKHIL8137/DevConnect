...
import signUpimg from '../../assets/images/freepik__background__66233.png'
...
const SignUp = () => {
  ...
  const googleLoginClient = ()=>{
    window.location = 'http://localhost:5000/user/auth/google?role=client'
  }
      ...
      <div className="w-full max-w-4xl bg-white rounded-xl shadow-lg overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 py-8 px-6 md:px-12 flex flex-col justify-center">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-800">Sign up to hire talent</h2>
          </div>
          <button 
            type="button"
            className="flex cursor-pointer items-center justify-center gap-2 border border-gray-300 rounded-full p-2 mb-6 hover:bg-gray-50 transition-colors"
          onClick={()=>googleLoginClient()}>
            ...
            <span>Log in with Google as a Client</span>
          </button>
