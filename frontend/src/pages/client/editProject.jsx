...
const EditProjectForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append(
        "keepAttachments",
        JSON.stringify(keepAttachmentIds)
      );
      if (
  ...
  return (
    <div className="pt-8 w-full min-h-screen bg-gray-100">
      <Navbar />
      {isLoading?<EditProjectSkeleton/>:<div className="flex flex-col py-12 px-4 sm:px-6 lg:px-8">
