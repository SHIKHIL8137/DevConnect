...
const FreelancerMarketplace =()=> {
  ...
  const categories = [
    "All", "Frontend", "Backend", "Full Stack", "DevOps", "Mobile", "UI/UX"
  ];
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:hidden mb-4">
            ...
            >
              ...
              <span>Filters</span>
              <ChevronDown size={20} className={`ml-2 transition-transform ${mobileFiltersOpen ? 'rotate-180' : ''}`} />
            </button>
          </div>
              ...
              <div className="mb-6">
                ...
                <ul>
                  {categories.map((category) => (
                    <li key={category} className={`py-2 px-3 mb-1 rounded-md cursor-pointer hover:bg-gray-100 ${category === 'All' ? 'bg-blue-100 text-blue-600' : ''}`}>
                      {category}
                    </li>
                  ))}
                </ul>
              ...
              <div className="mb-6">
                ...
                <ul>
                  {hourlyRates.map((rate) => (
                    <li key={rate} className="py-2 px-3 mb-1 rounded-md cursor-pointer hover:bg-gray-100">
                      {rate}
                    </li>
                  ))}
                </ul>
              ...
              <div>
                ...
                <ul>
                  {experienceLevels.map((level) => (
                    <li key={level} className="py-2 px-3 mb-1 rounded-md cursor-pointer hover:bg-gray-100">
                      {level}
                    </li>
                  ))}
                </ul>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <div className="flex items-center mt-1">
                          ...
                          <span className="ml-1 text-sm">{freelancer.rating}/5.0</span>
                        </div>
                      </div>
                    </div>
                    <div className="mt-4 sm:mt-0 text-right">
                      <p className="font-bold text-xl">${freelancer.hourlyRate}/hr</p>
                    </div>
                  </div>
