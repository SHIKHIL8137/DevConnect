...
const googleLogin = ()=>{
  window.location = 'http://localhost:5000/user/auth/google'
}
        ...
        <div className="w-full md:w-1/2 py-8 px-6 md:px-12 flex flex-col justify-center">
          ...
          <div className="space-y-6">
            ...
            <div className="text-right">
              <span onClick={()=>navigate('/forgotPassword')} className="text-sm text-gray-500 hover:text-blue-600 cursor-pointer">Forgot Password?</span>
            </div>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-500">
                No Account yet? 
                <span onClick={()=>navigate('/signUp')} className="text-blue-600 ml-1 font-medium cursor-pointer">SIGN UP</span>
              </p>
            </div>
          </div>
        </div>
