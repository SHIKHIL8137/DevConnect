...
import { doPasswordsMatch, isValidEmail, isValidPassword, validateOTP } from '../../util/validation.js';
import { forgetPassword, validateOtp, validateUserChangPswd } from '../../apis/userApi';
                  ...
                  <div className="flex justify-center">
                    {canResend ? (
                      ...
                      <p className="text-gray-500 text-sm flex items-center">
                        <Clock size={14} className="mr-1" /> Resend OTP in {countdown}s
                      </p>
                    )}
                  </div>
                )}
