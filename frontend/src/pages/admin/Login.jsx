  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-indigo-900 to-blue-800 text-white flex-col justify-between p-12">
        <div>
          <h1 className="text-3xl font-bold mb-2">Dev<span className="text-blue-300">Connect</span></h1>
          <p className="text-blue-200 mb-8">Connecting developers worldwide</p>
          
          <div className="mt-16">
            <h2 className="text-4xl font-bold leading-tight mb-6">
              Welcome to the <br />Professional Network <br />for Developers
            </h2>
            <p className="text-blue-200 text-lg max-w-md">
              Join thousands of freelancers and clients on the platform built specifically for development professionals.
            </p>
          </div>
        </div>
        ...
        <div>
          <div className="flex space-x-6 mb-8">
            <a href="#" className="p-2 bg-blue-800/30 rounded-full hover:bg-blue-700/50 transition-colors">
              <Github size={20} />
            </a>
            <a href="#" className="p-2 bg-blue-800/30 rounded-full hover:bg-blue-700/50 transition-colors">
              <Twitter size={20} />
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 bg-gray-50">
        <div className="w-full max-w-md">
          <div className="md:hidden text-center mb-10">
            <h1 className="text-3xl font-bold mb-2">Dev<span className="text-blue-600">Connect</span></h1>
